...
import { getReportLoanMembers, getReportMembers } from '@/app/utils/featuresApi';
import MainLayout from '@/components/mainLayout';
import { ReportLoanmember, ReportMember } from '@/types/interface';
...
const ReportMembers = async () => {
    ...
    const reports: ReportLoanmember[] = await getReportLoanMembers(session?.user.accessToken);
