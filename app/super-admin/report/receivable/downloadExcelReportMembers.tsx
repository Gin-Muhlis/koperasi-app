...
import { downloadExcelInvoice, downloadExcelReportLoanMembers, downloadExcelReportMembers, downloadExcelReportSavingMembers } from '@/app/utils/featuresApi'
...
const DownloadExcelReportMembers = () => {
    ...
    const handleDownloadExcel = async () => {
        ...
        const response = await downloadExcelReportLoanMembers(
        ...
        if (response.status == 200) {
            ...
            link.href = url;
            link.setAttribute("download", `Laporan Pinjaman Anggota Koperasi ${year}.xlsx`); // or any other extension
