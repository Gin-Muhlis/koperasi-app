...
import { downloadExcelInvoice, downloadExcelReportMembers, downloadExcelReportSavingMembers } from '@/app/utils/featuresApi'
...
const DownloadExcelReportMembers = () => {
    ...
    const handleDownloadExcel = async () => {
        ...
        const response = await downloadExcelReportSavingMembers(
        ...
        if (response.status == 200) {
            ...
            link.href = url;
            link.setAttribute("download", `Laporan Simpanan Anggota Koperasi ${year}.xlsx`); // or any other extension
