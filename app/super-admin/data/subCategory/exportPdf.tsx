...
import { downloadSubCategoriesDataPdf } from '@/app/utils/featuresApi'
...
const ExportPdf = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    const response = await downloadSubCategoriesDataPdf(session?.user.accessToken)
    ...
    if (response.status == 200) {
      ...
      link.href = url;
      link.setAttribute("download", "Data Sub Kategori.pdf")
