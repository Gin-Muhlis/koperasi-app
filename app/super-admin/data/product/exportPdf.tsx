...
import { downloadProductDataPdf } from '@/app/utils/featuresApi'
...
const ExportPdf = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    const response = await downloadProductDataPdf(session?.user.accessToken)
    ...
    if (response.status == 200) {
      ...
      link.href = url;
      link.setAttribute("download", "Data Produk.pdf")
