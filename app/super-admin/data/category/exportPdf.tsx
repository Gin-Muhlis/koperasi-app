...
import { downloadCategoriesDataPdf } from '@/app/utils/featuresApi'
...
const ExportPdf = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    const response = await downloadCategoriesDataPdf(session?.user.accessToken)
    ...
    if (response.status == 200) {
      ...
      link.href = url;
      link.setAttribute("download", "Data Kategori.pdf")
