...
import { downloadPositionCategoriesDataPdf } from '@/app/utils/featuresApi'
...
const ExportPdf = () => {
  ...
  const handleDownloadPdf = async () => {
    ...
    const response = await downloadPositionCategoriesDataPdf(session?.user.accessToken)
    ...
    if (response.status == 200) {
      ...
      link.href = url;
      link.setAttribute("download", "Data Golongan Anggota.pdf")
