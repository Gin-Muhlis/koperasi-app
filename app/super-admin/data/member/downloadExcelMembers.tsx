...
import { downloadExcelInvoice, downloadExcelReportMembers, downloadMembersData } from '@/app/utils/featuresApi'
...
const DownloadExcelMembersData = () => {
    ...
    const handleDownloadExcel = async () => {
        ...
        if (response.status == 200) {
            ...
            link.href = url;
            link.setAttribute("download", `Daftar Anggota Koperasi.xlsx`); // or any other extension
...
export default DownloadExcelMembersData